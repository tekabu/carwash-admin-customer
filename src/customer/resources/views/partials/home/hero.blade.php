...
<div class="hero-section">
    <div class="hero-slider2 owl-carousel owl-theme">
        <div class="hero-single" style="background: url({{ asset('publicx/assets/img/slider/slider5.png') }})">
            <div class="container">
                    ...
                    <div class="col-md-7 col-lg-7">
                        <div class="hero-content">
                            ...
                            <h1 class="hero-title wow animate__animated animate__fadeInUp"
                              ...
                              We Provide Professional <span>Carwash</span> Services
                            </h1>
        ...
        <div class="hero-single" style="background: url({{ asset('publicx/assets/img/slider/slider6.png') }})">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-7">
                        <div class="hero-content">
                            <h6 class="hero-sub-title wow animate__animated animate__fadeInUp"
                                data-wow-duration="1s" data-wow-delay=".25s">Protect Your Car’s Shine</h6>
                            <h1 class="hero-title wow animate__animated animate__fadeInUp"
                                data-wow-duration="1s" data-wow-delay=".50s">
                               We Offer Premium <span>Ceramic</span> & <span>Graphene</span> Coating
                            </h1>
                            <p class="wow animate__animated animate__fadeInUp" data-wow-duration="1s"
                                data-wow-delay=".75s">
        ...
        <div class="hero-single" style="background: url({{ asset('publicx/assets/img/slider/slider8.png') }})">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-md-7 col-lg-7">
                        <div class="hero-content">
                            <h6 class="hero-sub-title wow animate__animated animate__fadeInUp"
                                data-wow-duration="1s" data-wow-delay=".25s">Experience True Detailing Excellence</h6>
                            <h1 class="hero-title wow animate__animated animate__fadeInUp"
                                data-wow-duration="1s" data-wow-delay=".50s">
                                We Provide Complete <span>Auto Detailing</span> & <span>Paint Protection</span>
                            </h1>
                            <p class="wow animate__animated animate__fadeInUp" data-wow-duration="1s"
                                data-wow-delay=".75s">
